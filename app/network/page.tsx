...
export default async function NetworkPage() {
  ...
  return (
    <div className="container-wide py-20">
      ...
      <section className="mb-20">
        <div className="mb-6 flex items-center gap-2">
          <span className="status-dot status-dot-coming-soon" />
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="mt-2 text-[13px] leading-relaxed text-muted-foreground">
                ...
                and backed by U.S. Treasury bills. Yield from the reserves accrues to the
                protocol rather than to holders directly.
              </p>
            </div>
            <div className="flex items-start gap-3 rounded-lg border border-warning/30 bg-warning/[0.04] p-4">
              <div className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-warning" />
              <p className="text-[13px] leading-relaxed text-muted-foreground">
                <span className="text-foreground">Pending M0 Protocol API access.</span>{" "}
                M0 exposes T-bill yield data via{" "}
                <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-[12px]">
                  protocol-api.m0.org/graphql
                </code>{" "}
                but requires an API key (request at{" "}
                <a
                  href="https://www.m0.org/contact-us"
                  target="_blank"
                  rel="noreferrer"
                ...
                ). Populates once access is granted — no fabricated numbers.
              </p>
            </div>
          </div>
        </div>
